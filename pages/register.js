...
import ParticleBackground from 'src/components/ParticlesBackgroundEffect';
...
export default function LoginPage() {
  ...
  return (
    <Fragment>
      ...
      <div className="background h-[100vh] w-[100vw] bg-center">
        <ParticleBackground />
        <MainNavbar />
        <main>
          <div className="h-full w-full py-10 px-4">
            <div className="flex flex-col items-center justify-center">
              <div className="bg-white bg-opacity-60 filter backdrop-blur-md shadow rounded-2xl md:w-2/4 lg:w-2/5 xl:2/5 2xl:w-1/4 w-full w- py-10 px-14 mt-16">
                <p
                  tabIndex="0"
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mt-8">
                    <button
                      role="button"
                      type="submit"
                      className="text-md font-semibold leading-none text-white drop-shadow-md shadow-sky-400 bg-gray-800 hover:bg-gray-700 border-none rounded-full py-4 w-full transition duration-500"
                    >
                      Sign Up
                    </button>
                  </div>
